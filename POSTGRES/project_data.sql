CREATE TABLE "Game99" (
    ...
    CONSTRAINT "pk_Game99" PRIMARY KEY (
        "GameId"
     )
);
...
create TABLE "Play99" (
    ...
    CONSTRAINT "pk_Play99" PRIMARY KEY (
        "PlayId"
     )
);
...
-- load Game table
insert into public."Game99" ("GameId", "GameDate")
select DISTINCT "GameId", "GameDate" from public."Temp99";

-- load Play table
insert into public."Play99" ("GameId", "Quarter", "Minute", "Second", "OffenseTeam", "DefenseTeam", "Down", "ToGo", "Yards", "YardsPlusMinus", "Successful3rdDown", "YardLine", "SeriesFirstDown", "NextScore", "Description", "TeamWin", "SeasonYear", "Formation", "PlayType", "IsRush", "IsPass", "IsIncomplete", "IsTouchdown", "PassType", "IsSack", "IsChallenge", "IsChallengeReversed", "IsMeasurement", "IsInterception", "IsFumble", "IsPenalty", "IsTwoPointConversion", "IsTwoPointConversionSuccessful", "RushDirection", "YardLineFixed", "YardLineDirection", "IsPenaltyAccepted", "PenaltyTeam", "IsNoPlay", "PenaltyType", "PenaltyYards")
...
-- Check table counts
select 'temp99', count(*) as Total from public."Temp99"
union all
select 'play99', count(*) as Total from public."Play99"
union all
select 'game99', count(*) as Total from public."Game99";
